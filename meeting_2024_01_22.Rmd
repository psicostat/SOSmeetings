...
Da anni *Giunti Psychometrics* (non da sola) produce e pubblica strumenti psicometrici che **NON riportano in chiaro i dati minimi necessari per verificare attendibilità e correttezza dei punteggi standardizzati / dei profili**, cioè statistiche descrittive dei punteggi grezzi per ogni campione e subcampione, tabelle di conversione grezzo-ponderato, matrici di varianza e covarianza
...
- \small Statistiche descrittive dei punteggi standardizzati *(serious, Giunti?!)*
...
È accettabile che **diagnosi** e **certificazioni** con **impatto legale** e **sociale** si basino su punteggi elaborati da un editore privato tramite una *"black box"* opaca il cui **unico garante è lo stesso editore che vende il test**?
...
knitr::include_graphics("figurafrontespizioinesattezze2.png")
```
